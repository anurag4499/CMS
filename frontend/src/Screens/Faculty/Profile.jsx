...
const Profile = () => {
  ...
  useEffect(() => {
    ...
    axios
      .post(
        `http://localhost:5000/api/${router.state.type}/details/getDetails`,
  ...
  const checkPasswordHandler = (e) => {
    ...
    axios
      .post(
        `http://localhost:5000/api/faculty/auth/login`,
  ...
  const changePasswordHandler = (id) => {
    ...
    axios
      .put(
        `http://localhost:5000/api/faculty/auth/update/${id}`,
    ...
    <div className="w-full mx-auto my-8 flex justify-between items-start">
      {data && (
        <>
          ...
          <img
            src={ "http://localhost:5000/media/" + data[0].profile}
            alt="faculty profile"
